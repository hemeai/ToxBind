...
The decribes a way to 3 kind of proteins
...
- [x] Remove duplicate runs, and re-run of the same thing again and again 
- [x] Add target sequence, Folder
- [x] PBD ID of target sequence, Date and BindCraft version
