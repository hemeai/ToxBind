...
TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/7z14.pdb --chains F --target-hotspot-residues F8,F10,F25,F28,F45 --lengths 72,96 --design-protocol Beta-sheet --number-of-final-designs 1

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/1yi5.pdb --chains F --target-hotspot-residues F7,F27,F28,F29,F31,F32,F33,F34,F35,F36 --lengths 102,102 --number-of-final-designs 2

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/1yi5.pdb --chains F --lengths 102,102 --number-of-final-designs 2

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/1yi5.pdb --chains F --target-hotspot-residues F35 --lengths 102,102 --number-of-final-designs 1

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/1yi5.pdb --chains F --target-hotspot-residues F31,F32,F33,F34,F35,F36 --lengths 102,102 --number-of-final-designs 5

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/1yi5.pdb --chains F --target-hotspot-residues F31,F32,F33,F34,F35,F36 --lengths 72,96 --number-of-final-designs 5

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/8d9y.pdb --chains I --target-hotspot-residues I7,I10,I28,I34 --lengths 72,96 --number-of-final-designs 1

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/8d9y.pdb --chains I --target-hotspot-residues I7,I10,I28,I34 --lengths 96,120 --number-of-final-designs 1

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/8d9y.pdb --chains I --lengths 72,96 --number-of-final-designs 1

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/7z14.pdb --chains F --lengths 72,96 --number-of-final-designs 1

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/7z14.pdb --target-chains F --lengths 72,96 --number-of-final-designs 1 --max-trajectories 2

TIMEOUT=1400 GPU=A100 modal run --detach modal_bindcraft.py --input-pdb ./target/7z14.pdb --target-chains F --lengths 72,96 --number-of-final-designs 1 --max-trajectories 1

uvx modal run ./scripts/modal_mosaic.py --workers 1 --max-time-hours 1.0

uv modal run ./scripts/foldism/foldism.py --input-faa ./../analysis/test.fasta --algorithms boltz2

python scripts/prepare_chai1_input.py --input ./../out/mosaic/20260201/designs.txt


uvx modal run ./scripts/modal_mosaic.py --workers 1 --max-time-hours 1.0

TIMEOUT=1400 GPU=A100 modal run --detach ./scripts/modal_bindcraft.py --input-pdb ./../target/AF-P59071-F1-model_v6.pdb --target-chains A --lengths 72,96 --number-of-final-designs 1

TIMEOUT=1400 GPU=A100 modal run --detach ./scripts/modal_bindcraft.py --input-pdb ./target/AF-P59071-F1-model_v6.pdb --target-chains A --target-hotspot-residues A24,A25,A26 --lengths 72,96 --number-of-final-designs 1


### More like peptides
TIMEOUT=1400 GPU=A100 modal run --detach ./scripts/modal_bindcraft.py --input-pdb ./target/AF-P59071-F1-model_v6.pdb --target-chains A --target-hotspot-residues A24,A25,A26 --lengths 24,36 --number-of-final-designs 1 --max-trajectories 1

The above one didn't produce any result. Even after running for the whole day. 
Now trying with max-trajectories limit
